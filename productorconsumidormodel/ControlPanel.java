...
public class ControlPanel extends JPanel {
    ...
    private JLabel cPanelL;
    
    public ControlPanel(ProductorConsumidorView view) {
        this.view = view;
    ...
    void updateValues() {
        this.view.controller.labParam.preventNegativeStocks = this.preventNegativeStocks.isSelected();
        this.view.controller.labParam.protectCriticalRegions = this.protectCriticalRegions.isSelected();
    }

    void setParams() {
        this.preventNegativeStocks.setSelected(this.view.controller.labParam.preventNegativeStocks);
        this.protectCriticalRegions.setSelected(this.view.controller.labParam.protectCriticalRegions);
