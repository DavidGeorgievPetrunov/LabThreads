            ...
            case "Play": {
                try {
                    if (this.cPanel.playPause.isSelected()) {
                        // TO DO
                        // Evitar que el programa se realize si no puede haber stock negativo pero 
                        // el resultado del contador de consumidores es mas alto que el de productores
                        if (this.controller.getLabParam().preventNegativeStocks == true
                                && ((this.controller.getLabParam().cantidadConsumidoresTF) * (this.controller.getLabParam().cantidadItemsxConsumidor))
                                > ((this.controller.getLabParam().cantidadItemsxProductor) * (this.controller.getLabParam().cantidadProductoresTF))) {
                            System.out.println("Los consumidores son mayores a los productres con prevent negative stock = true, no se realizara la accion");
                            break;
                        } else {
                        ...
                        if (this.controller.getLabParam().stop = false) {
